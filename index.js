...
bot.on("message", async message => {
    ...
    // Check if DM
    if ((message.channel.id !== channels.voiceChannel) && (message.channel.type !== "dm")) { // If Message is Not in the Voice Channel AND Not a DM...
        await score(bot, message, sql);
    } else if (message.channel.type === "dm") { // If Message is a DM...
